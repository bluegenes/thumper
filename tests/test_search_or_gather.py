...
def test_empty_1(location):
    ...
    args.genome_sig = utils.test_file("test-data/intermediate/GB_GCA_000384615.1_protein.100contigs.faa.gz.sig")
    args.matches_sig = utils.test_file("test-data/intermediate/GB_GCA_000384615.1_protein.100contigs.faa.gz.x.gtdb-nine.protein-k11.matches.sig")
...
def test_contig_search(location):
    ...
    args.genome_sig = utils.test_file("test-data/intermediate/GB_GCA_002691795.1_protein.100contigs.faa.gz.sig")
    args.matches_sig = utils.test_file("test-data/intermediate/GB_GCA_002691795.1_protein.100contigs.faa.gz.x.gtdb-nine.protein-k11.matches.sig")
    args.lineages_csv = utils.test_file("test-data/databases/gtdb-nine.lineages.csv")
    args.alphabet = "protein"
    args.ksize = 33
    ...
    saved_search_csv = \
    utils.test_file("test-data/intermediate/GB_GCA_002691795.1_protein.100contigs.faa.gz.x.gtdb-nine.protein-k11.contigs.search.csv")
    ...
    utils.test_file("test-data/intermediate/GB_GCA_002691795.1_protein.100contigs.faa.gz.x.gtdb-nine.protein-k11.contigs.ranksearch.csv")
    ...
    utils.test_file("test-data/intermediate/GB_GCA_002691795.1_protein.100contigs.faa.gz.x.gtdb-nine.protein-k11.contigs.search.matches.sig")
    ...
    utils.test_file("test-data/intermediate/GB_GCA_002691795.1_protein.100contigs.faa.gz.x.gtdb-nine.protein-k11.contigs.ranksearch.matches.sig")
...
def test_contig_search_and_gather(location):
    ...
    utils.test_file("test-data/intermediate/GB_GCA_002691795.1_protein.100contigs.faa.gz.x.gtdb-nine.protein-k11.contigs.rankgather.csv")
