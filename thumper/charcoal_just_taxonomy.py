...
version from https://github.com/dib-lab/charcoal/pull/110
"""
import sys
import argparse
import gzip
...
from thumper import charcoal_utils
from thumper import lineage_db
from thumper.lineage_db import LineageDB
from thumper.version import version
from thumper.charcoal_utils import (get_idents_for_hashval, gather_lca_assignments,
...
def main(args):
    ...
    #report(f'thumper version: v{version}')
